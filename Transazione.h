...
public:
    Transazione(){}
    Transazione(const typeTransaction t, float i, std::shared_ptr<Conto> m,  std::shared_ptr<Conto> r, const DateTime& d, bool comp);
    ...
    void setDataora(const DateTime& dataora);
