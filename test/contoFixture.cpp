...
TEST_F(contoSuite, someTransaction){
    ...
    std::string filenameMyFileTransaction = me->getNome() + me->getCognome() + myBankAccount->getNome() + "Transaction.txt";
    std::string filenameOtherFileTransaction = other->getNome() + other->getCognome() + otherBankAccount->getNome() + "Transaction.txt";
    float mySaldo = 0;
    float otherSaldo = 0;
...
TEST_F(contoSuite, someInvestment) {
    ...
    std::string filenameMyFileTransaction = me->getNome() + me->getCognome() + myBankAccount->getNome() + "Transaction.txt";
    std::string filenameOtherFileTransaction = other->getNome() + other->getCognome() + otherBankAccount->getNome() + "Transaction.txt";
    std::string filenameMyFileInvestment = me->getNome() + me->getCognome() + myBankAccount->getNome() + "Investment.txt";
    std::string filenameOtherFileInvestment = other->getNome() + other->getCognome() + otherBankAccount->getNome() + "Investment.txt";
    float mySaldo = 0;
    float otherSaldo = 0;
    ...
    //remove investimenti
    float saldo_now = myBankAccount->getSaldo();
...
TEST_F(contoSuite, sameUserDifferentBankaccount) {
    ...
    std::string filenameMyFileTransaction1 =
            me->getNome() + me->getCognome() + myBankAccount->getNome() + "Transaction.txt";
    std::string filenameMyFileTransaction2 =
            other->getNome() + other->getCognome() + myBankAccount2->getNome() + "Transaction.txt";
    std::string filenameMyFileInvestment1 =
            me->getNome() + me->getCognome() + myBankAccount->getNome() + "Investment.txt";
    std::string filenameMyFileInvestment2 =
            other->getNome() + other->getCognome() + myBankAccount2->getNome() + "Investment.txt";
    float mySaldo = 0;
    float otherSaldo = 0;
    float myMoneyInvested = 0;
    float otherMoneyInvested = 0;
    ...
    std::shared_ptr<Transazione> p1 = std::make_shared<Transazione>(typeTransaction::Prelievo, 100, myBankAccount, myBankAccount,  &dt2, false);
    std::shared_ptr<Transazione> p2 = std::make_shared<Transazione>(typeTransaction::Prelievo, 100, myBankAccount2, myBankAccount2, &dt2, false);
